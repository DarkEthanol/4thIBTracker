...
public partial class ForumCoursesView : UserControl
{
    private bool _webViewReady;

    public ForumCoursesView(ForumCoursesViewModel vm)
    {
        InitializeComponent();
        DataContext = vm;
    ...
    /// <summary>Navigate the hidden WebView2 to a URL and return the rendered page HTML.</summary>
